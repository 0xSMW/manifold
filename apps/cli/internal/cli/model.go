...
func newModelCmd() *cobra.Command {
	...
	c.AddCommand(
		buildLeaf(cmdSpec{Use: "list", Short: "list canonical models", Args: cobra.NoArgs, Kind: "model.list"}),
		buildLeaf(cmdSpec{Use: "get <id>", Short: "get a model", Args: cobra.ExactArgs(1), Kind: "model.get"}),
