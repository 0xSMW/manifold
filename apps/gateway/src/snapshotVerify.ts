 ...
 * verify and THROW (fail closed) on any mismatch. When no key is pinned, allow an unsigned snapshot
 * but warn LOUDLY — the DEV escape hatch that keeps snapshot.example.json booting locally.
 */
